    ...
    <section>
      <div className="custom-screen pt-[60px] pb-28 flex flex-none items-center flex-col flex-nowrap gap-[80px] h-min justify-center overflow-hidden relative w-full">
        <div className=" duration-1000 delay-300 opacity-1">
          <div className="max-w-3xl mx-auto text-center flex flex-col flex-nowrap gap-[40px] justify-center items-center overflow-visible min-h-min">
            <div className="relative w-auto opacity-100" style={{transform: "perspective(1200px)"}}>
              <div className="contents">
                <a className="flex flex-row items-center flex-nowrap gap-[8px] min-h-min justify-center overflow-visible py-[8px] pl-[16px] pr-[8px] relative min-w-min border-solid border-x-0 border-y-0 border-transparent bg-white rounded-[40px] opacity-100" href="./design-token-format">
            ...
            <div className="flex flex-none flex-col items-center gao-0 h-min justify-start overflow-visible p-0relative w-full opacity-100 " style={{ transform: "perspective(1200px)" }}>
              <div className="flex-none h-auto relative whitespace-pre-wrap w-full break-words outline-0 flex flex-col justify-start shrink-0">
                ...
                <h1 className="font-sans sm:text-[64px] text-[48px] not-italic font-bold tracking-tight sm:leading-[72px] leading-[56px] text-white text-center">with an open, permissions identity layer</h1>
              </div>
