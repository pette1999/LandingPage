      ...
      <div className="mt-16 justify-center gap-6 sm:grid sm:grid-cols-2 sm:space-y-0 lg:grid-cols-3 duration-1000 delay-300 opacity-1">
        <div className="relative flex-1 flex items-stretch flex-col rounded-xl border border-gray-800 mt-6 sm:mt-0 ">
          <div className="p-8 space-y-4 border-b border-gray-800 text-center">
            ...
            <p className="text-gray-400">Ideal for growing finance</p>
          </div>
          <div className="p-8">
            ...
            <div className="pt-8">
              <button role="button" className="w-full rounded-full text-white ring-offset-2 focus:ring bg-gray-800 hover:bg-gray-700 ring-gray-800 px-4 py-2.5 font-medium text-sm text-center duration-150">
                Coming Soon!
              </button>
            </div>
          </div>
        ...
        <div className="box-color relative flex-1 flex items-stretch flex-col rounded-xl border border-gray-800 mt-6 sm:mt-0 hover:border-[#076AE0]">
          <div className="p-8 space-y-4 border-b border-gray-800 text-center">
            <span className="text-[#076AE0] font-medium">Basic plan</span>
            <div className="text-gray-50 text-3xl font-semibold">
              $0
              <span className="text-xl text-gray-400 font-normal">/mo</span>
            </div>
