...
export default function Navbar() {
  ...
  return (
    ...
    //     </div>
    //   </div>
    //   <nav className={`pb-5 md:text-sm md:static md:block ${openMenu ? 'bg-gray-900 absolute z-20 top-0 inset-x-0 rounded-b-2xl md:bg-gray-900' : 'md:text-sm md:static md:block hidden'} flex flex-nowrap h-min justify-center relative flex-col gap-[40px] overflow-auto overscroll-contain px-[16px] w-full`}>
    //     <div className="custom-screen items-center md:flex hidden">
    //       <div className="flex items-center justify-between py-5 md:block">
    //         <a href="/" className="flex items-center">
    //           <img src={hexlink} width={30} height={30} />
    //           <h1 className="text-[25px] text-white font-bold pl-2">Hexlink</h1>
    ...
    //       </div>
    //     </div>
    //     <div className={`md:hidden flex flex-none flex-nowrap h-min justify-center overflow-visible p-0 relative z-1 w-full gap-[24px] items-start flex-col`} style={{transform: "none", transformOrigin: "50% 50% 0px;"}}>
    //       <div className="flex-none h-auto relative w-auto opacity-100" style={{ transform: "none", transformOrigin: "50% 50% 0px;" }}>
    //         <div className="contents">
    //           <a className="items-start cursor-pointer flex flex-col flex-nowrap gap-[0px] h-min relative w-min justify-start p-0 border-0 border-transparent border-solid" style={{ transform: "none", transformOrigin: "50% 50% 0px;" }} href="https://specifyapp.com/templates">
    //             <div className="flex-none h-auto relative whitespace-pre w-auto flex flex-col justify-start shrink-0 text-white" style={{ transform: "none", transformOrigin: "50% 50% 0px;" }}>
    //               <h4 className="font-sans text-2xl not-italic font-semibold leading-8 text-start">Templates</h4>
    //             </div>
    //           </a>
    //         </div>
    //       </div>
